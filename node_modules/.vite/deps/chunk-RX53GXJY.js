    ...
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(r) {
        switch (r.label) {
          ...
          case 1:
            return n = r.sent(), [4, function(t4, e3) {
              var n2 = F2(t4), r2 = En(e3.createTime);
              return n2.persistence.runTransaction("hasNewerBundle", "readonly", function(t5) {
                return n2.Ke.getBundleMetadata(t5, e3.id);
              }).then(function(t5) {
                return !!t5 && t5.createTime.compareTo(r2) >= 0;
              });
            }(t3.localStore, n)];
          case 2:
            return r.sent() ? [4, e2.close()] : [3, 4];
          case 3:
            return [2, (r.sent(), void i2._completeWith(function(t4) {
              return {
                taskState: "Success",
          ...
          case 4:
            return i2._updateProgress(Ss(n)), o2 = new Es(n, t3.localStore, e2.R), [4, e2.Lo()];
          case 5:
            s = r.sent(), r.label = 6;
          case 6:
          ...
          case 11:
            return a = r.sent(), [4, Ys(
              t3,
              a.wn,
              void 0
            )];
          case 12:
            return r.sent(), [4, function(t4, e3) {
              var n2 = F2(t4);
              return n2.persistence.runTransaction("Save bundle", "readwrite", function(t5) {
                return n2.Ke.saveBundleMetadata(t5, e3);
              });
            }(t3.localStore, n)];
          case 13:
  ...
  return {
    read: function() {
      return __awaiter(this, void 0, void 0, function() {
        var n;
        return __generator(this, function(r) {
          return i < t2.byteLength ? (n = {
            value: t2.slice(i, i + e),
            done: false
          }, [2, (i += e, n)]) : [2, {
            done: true
          }];
...
function Gc2(t2) {
  return function(t3, e) {
    var i = aa2(t3 = zu(t3, ua2)), o = new oa2();
    return function(t4, e2, i2, o2) {
      var s = this, u = function(t5, e3) {
        return function(t6, e4) {
          return new vu(t6, e4);
        }(function(t6, e4) {
          if (t6 instanceof Uint8Array)
            return pu(t6, e4);
          if (t6 instanceof ArrayBuffer)
            return pu(new Uint8Array(t6), e4);
          if (t6 instanceof ReadableStream)
            return t6.getReader();
          throw new Error("Source of `toByteStreamReader` has to be a ArrayBuffer or ReadableStream");
        }("string" == typeof t5 ? new TextEncoder().encode(t5) : t5), e3);
      }(i2, Co(e2));
    ...
    }(i, t3._databaseId, e, o), o;
  }(this._delegate, t2);
}
function Qc2(t2) {
  var e, i, o = this;
  return (e = this._delegate, i = t2, function(t3, e2) {
    var i2 = this;
    return t3.asyncQueue.enqueue(function() {
      return __awaiter(i2, void 0, void 0, function() {
        var n;
        return __generator(this, function(r) {
          switch (r.label) {
            case 0:
              return n = function(t4, e3) {
                var n2 = F2(t4);
                return n2.persistence.runTransaction("Get named query", "readonly", function(t5) {
                  return n2.Ke.getNamedQuery(t5, e3);
                });
              }, [4, Su(t3)];
            case 1:
  ...
  }(aa2(e = zu(e, ua2)), i).then(function(t3) {
    return t3 ? new Xu(e, null, t3.query) : null;
  })).then(function(t3) {
    return t3 ? new Mc2(o, t3) : null;
  });
}
...
//# sourceMappingURL=chunk-RX53GXJY.js.map
