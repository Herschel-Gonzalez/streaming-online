import "./chunk-VPVKUWXM.js";
import {
  Gc,
  Qc,
  Sc
} from "./chunk-C6UIAP2P.js";
import {
  Component,
  ComponentContainer,
  Deferred,
...
function query(query2) {
  ...
  try {
    ...
    try {
      if (queryConstraints_1_1 && !queryConstraints_1_1.done && (_a7 = queryConstraints_1.return))
        _a7.call(queryConstraints_1);
    } finally {
      if (e_1)
        throw e_1.error;
    }
...
function registerDatabase(instance) {
  ...
  var namespace = instance.INTERNAL.registerComponent(new Component("database", function(container, _a7) {
...
function callFidChangeCallbacks(key, fid) {
  ...
  try {
    ...
    try {
      if (callbacks_1_1 && !callbacks_1_1.done && (_a7 = callbacks_1.return))
        _a7.call(callbacks_1);
    } finally {
      if (e_1)
        throw e_1.error;
    }
...
function extractAppConfig(app) {
  ...
  try {
    ...
    try {
      if (configKeys_1_1 && !configKeys_1_1.done && (_a7 = configKeys_1.return))
        _a7.call(configKeys_1);
    } finally {
      if (e_1)
        throw e_1.error;
    }
      ...
      switch (_b.label) {
        ...
        case 1:
          ...
          try {
            ...
            try {
              if (clientList_1_1 && !clientList_1_1.done && (_a7 = clientList_1.return))
                _a7.call(clientList_1);
            } finally {
              if (e_1)
                throw e_1.error;
            }
...
function sendMessagePayloadInternalToWindows(clientList, internalPayload) {
  ...
  try {
    ...
    try {
      if (clientList_2_1 && !clientList_2_1.done && (_a7 = clientList_2.return))
        _a7.call(clientList_2);
    } finally {
      if (e_2)
        throw e_2.error;
    }
...
var _a3;
var ERROR_DESCRIPTION_MAP2 = (_a3 = {}, _a3["trace started"] = "Trace {$traceName} was started before.", _a3["trace stopped"] = "Trace {$traceName} is not running.", _a3["nonpositive trace startTime"] = "Trace {$traceName} startTime should be positive.", _a3["nonpositive trace duration"] = "Trace {$traceName} duration should be positive.", _a3["no window"] = "Window is not available.", _a3["no app id"] = "App id is not available.", _a3["no project id"] = "Project id is not available.", _a3["no api key"] = "Api key is not available.", _a3["invalid cc log"] = "Attempted to queue invalid cc event", _a3["FB not default"] = "Performance can only start when Firebase app instance is the default one.", _a3["RC response not ok"] = "RC response is not ok", _a3["invalid attribute name"] = "Attribute name {$attributeName} is invalid.", _a3["invalid attribute value"] = "Attribute value {$attributeValue} is invalid.", _a3["invalid custom metric name"] = "Custom metric name {$customMetricName} is invalid", _a3["invalid String merger input"] = "Input for String merger is invalid, contact support team to resolve.", _a3);
...
var _a4;
var ERRORS = (_a4 = {}, _a4["already-exists"] = "A Firebase Analytics instance with the appId {$id}  already exists. Only one Firebase Analytics instance can be created for each appId.", _a4["already-initialized"] = "Firebase Analytics has already been initialized.settings() must be called before initializing any Analytics instanceor it will have no effect.", _a4["interop-component-reg-failed"] = "Firebase Analytics Interop Component failed to instantiate: {$reason}", _a4["invalid-analytics-context"] = "Firebase Analytics is not supported in this environment. Wrap initialization of analytics in analytics.isSupported() to prevent initialization in unsupported environments. Details: {$errorInfo}", _a4["indexeddb-unavailable"] = "IndexedDB unavailable or restricted in this environment. Wrap initialization of analytics in analytics.isSupported() to prevent initialization in unsupported environments. Details: {$errorInfo}", _a4["fetch-throttle"] = "The config fetch request timed out while in an exponential backoff state. Unix timestamp in milliseconds when fetch request throttling ends: {$throttleEndTimeMillis}.", _a4["config-fetch-failed"] = "Dynamic config fetch failed: [{$httpStatus}] {$responseMessage}", _a4["no-api-key"] = 'The "apiKey" field is empty in the local Firebase config. Firebase Analytics requires this field tocontain a valid API key.', _a4["no-app-id"] = 'The "appId" field is empty in the local Firebase config. Firebase Analytics requires this field tocontain a valid app ID.', _a4);
...
var _a5;
var ERROR_DESCRIPTION_MAP3 = (_a5 = {}, _a5["registration-window"] = "Undefined window object. This SDK only supports usage in a browser environment.", _a5["registration-project-id"] = "Undefined project identifier. Check Firebase app initialization.", _a5["registration-api-key"] = "Undefined API key. Check Firebase app initialization.", _a5["registration-app-id"] = "Undefined app identifier. Check Firebase app initialization.", _a5["storage-open"] = "Error thrown when opening storage. Original error: {$originalErrorMessage}.", _a5["storage-get"] = "Error thrown when reading from storage. Original error: {$originalErrorMessage}.", _a5["storage-set"] = "Error thrown when writing to storage. Original error: {$originalErrorMessage}.", _a5["storage-delete"] = "Error thrown when deleting from storage. Original error: {$originalErrorMessage}.", _a5["fetch-client-network"] = "Fetch client failed to connect to a network. Check Internet connection. Original error: {$originalErrorMessage}.", _a5["fetch-timeout"] = 'The config fetch request timed out.  Configure timeout using "fetchTimeoutMillis" SDK setting.', _a5["fetch-throttle"] = 'The config fetch request timed out while in an exponential backoff state. Configure timeout using "fetchTimeoutMillis" SDK setting. Unix timestamp in milliseconds when fetch request throttling ends: {$throttleEndTimeMillis}.', _a5["fetch-client-parse"] = "Fetch client could not parse response. Original error: {$originalErrorMessage}.", _a5["fetch-status"] = "Fetch server returned an HTTP error status. HTTP status: {$httpStatus}.", _a5);
...
var _a6;
var ERRORS2 = (_a6 = {}, _a6["already-activated"] = "You are trying to activate AppCheck for FirebaseApp {$appName}, while it is already activated. AppCheck can only be activated once.", _a6["use-before-activation"] = "AppCheck is being used before activate() is called for FirebaseApp {$appName}. Please make sure you call activate() before instantiating other Firebase services.", _a6["fetch-network-error"] = "Fetch failed to connect to a network. Check Internet connection. Original error: {$originalErrorMessage}.", _a6["fetch-parse-error"] = "Fetch client could not parse response. Original error: {$originalErrorMessage}.", _a6["fetch-status-error"] = "Fetch server returned an HTTP error status. HTTP status: {$httpStatus}.", _a6["storage-open"] = "Error thrown when opening storage. Original error: {$originalErrorMessage}.", _a6["storage-get"] = "Error thrown when reading from storage. Original error: {$originalErrorMessage}.", _a6["storage-set"] = "Error thrown when writing to storage. Original error: {$originalErrorMessage}.", _a6["recaptcha-error"] = "ReCAPTCHA error.", _a6);
